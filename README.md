...
==========================================================
Video Scene Cut Detection and Analysis Tool. This repo is forked from https://github.com/Breakthrough/PySceneDetect and modified slightly to make output files bids-compliant. 
----------------------------------------------------------
