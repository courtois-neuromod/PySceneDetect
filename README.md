...
==========================================================
Video Scene Cut Detection and Analysis Tool. This repo is forked from <a "https://github.com/Breakthrough/PySceneDetect"> here</a> and modified slightly to make output files bids-compliant. 
----------------------------------------------------------
